...
pforce <- ggplot(bite_data_long, aes(Bitework, value, fill = name)) + 
  ...
  scale_fill_manual(values = munch_palette("Scream1",2), name = " ") +
  ylab("Bite force quotient") + 
  theme_bw()
pforce
```
...
```{r fig-3, echo=FALSE, warning=FALSE, fig.cap="K-means clustering plot.", fig.height=7.5, fig.width=12}
pscent + pbite + plot_layout(guides = "collect") + plot_annotation(tag_levels = "A")
```
