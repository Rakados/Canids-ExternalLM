...
skulls <- cbind(SlicerMorph.repc[,1:5], "UKC" = SlicerMorph.repc$UKC, "AKC" = SlicerMorph.repc$AKC)
skulls <- na.omit(skulls)

skullCVA <- CVA(skulls[,1:5],skulls$UKC)

plot(skullCVA$CVscores)

cvvis5 <- 5*skullCVA$CVvis[,1]+skullCVA$Grandm
cvvisNeg5 <- -5*skullCVA$CVvis[,1]+skullCVA$Grandm
