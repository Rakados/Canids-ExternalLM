...
```{r}
# Save tables for SI
write.csv(p_values_AKC[-1, -8], file ="./results/Table_S3_AKC_pvalues.csv")
write.csv(p_values_UKC[-1, -9], file ="./results/Table_S4_UKC_pvalues.csv")
```
...
(pAKC + ggtitle("AKC") + pUKC + ggtitle("UKC")) / (p_CVA_AKC + p_CVA_UKC) + 
