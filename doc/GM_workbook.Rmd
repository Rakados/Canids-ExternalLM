...
try(library(myriad)) # Loading a the myriad font package, if loading fails then figures will use default font family.
if(any(library()$results[,"Package"] == "myriad")) theme_set(theme_myriad_semi())
```
...
design2 <- 
  "AAAA
   ...
   BBBB"
(pUKC ) / 
  (p_UKC_compare + ggtitle(" ")) + 
  plot_layout(design = design2) +
  plot_annotation(tag_levels = "A")
ggsave("./results/figures/figure3.pdf", height = 9*0.95, width = 9.6*0.95)
```
...
design2 <- 
  "AAAA
   AAAA
   BBBB"
pAKC / (p_AKC_compare + ggtitle(" "))+
  plot_layout(design = design2) +
  plot_annotation(tag_levels = "A")
ggsave("./results/figures/figure4.pdf", height = 9*0.95, width = 9.6*0.95)
```
...
(pscent + pbite + plot_layout(guides = "collect") & theme(legend.position = "right")) / 
  ...
  plot_layout(design = design2) +
  plot_annotation(tag_levels = "A")
ggsave("./results/figures/figure5.pdf", width = 10, height = 12)
```
